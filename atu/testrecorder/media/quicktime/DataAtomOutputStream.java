  ...
  extends FilterOutputStream
{
  ...
  public void writeMacTimestamp(Date date)
    throws IOException
  {
  ...
  public void writeFixed16D16(double f)
    throws IOException
  {
    double v = f >= 0.0D ? f : -f;
    
    int wholePart = (int)Math.floor(v);
    int fractionPart = (int)((v - wholePart) * 65536.0D);
  ...
  public void writeFixed2D30(double f)
    throws IOException
  {
    double v = f >= 0.0D ? f : -f;
    
    int wholePart = (int)v;
    int fractionPart = (int)((v - wholePart) * 1.073741824E9D);
  ...
  public void writeFixed8D8(float f)
    throws IOException
  {
    float v = f >= 0.0F ? f : -f;
    
    int wholePart = (int)v;
    int fractionPart = (int)((v - wholePart) * 256.0F);
  ...
  public void writePString(String s, int length)
    throws IOException
  {
    if (s.length() > length) {
